...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'longfor', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'longfor design 3.0', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '为用户提供简洁 一键直达的操作体验。', // 作者简介
